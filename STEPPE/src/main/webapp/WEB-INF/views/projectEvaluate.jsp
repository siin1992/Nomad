...
<html>
	<head>
		...
		<style>
			...
			.e_score>.input,
			.e_score>.input>label:hover,
			.e_score>.input>input:focus+label,
			.e_score>.input>input:checked+label{
			...
			.e_score>.input>label:hover~label{
			    background-image: none;
			}
			.e_score>.input>label[for="p1"]{ 
			    width: 10px;
			    z-index: 10;
			}
			.e_score>.input>label[for="p2"]{ 
			    width: 20px;
			    z-index: 9;
			}
			.e_score>.input>label[for="p3"]{ 
			    width: 30px;
			    z-index: 8;
			}
			.e_score>.input>label[for="p4"]{ 
			    width: 40px;
			    z-index: 7;
			}
			.e_score>.input>label[for="p5"]{ 
			    width: 50px;
			    z-index: 6;
			}
			.e_score>.input>label[for="p6"]{ 
			    width: 60px;
			    z-index: 5;
			}
			.e_score>.input>label[for="p7"]{ 
			    width: 70px;
			    z-index: 4;
			}
			.e_score>.input>label[for="p8"]{ 
			    width: 80px;
			    z-index: 3;
			}
			.e_score>.input>label[for="p9"]{ 
			    width: 90px;
			    z-index: 2;
			}
			.e_score>.input>label[for="p10"]{ 
			    width: 100px;
			    z-index: 1;
			}
			.e_score>output{
				...
				<table>
					...
					<tr>
						<td>
							<span class="e_score">
								<span class="input">
								<input type="radio" name="e_score" id="p1" value="1"><label for="p1">1</label>
								<input type="radio" name="e_score" id="p2" value="2"><label for="p2">2</label>
								<input type="radio" name="e_score" id="p3" value="3"><label for="p3">3</label>
								<input type="radio" name="e_score" id="p4" value="4"><label for="p4">4</label>
								<input type="radio" name="e_score" id="p5" value="5"><label for="p5">5</label>
								<input type="radio" name="e_score" id="p6" value="6"><label for="p6">6</label>
								<input type="radio" name="e_score" id="p7" value="7"><label for="p7">7</label>
								<input type="radio" name="e_score" id="p8" value="8"><label for="p8">8</label>
								<input type="radio" name="e_score" id="p9" value="9"><label for="p9">9</label>
								<input type="radio" name="e_score" id="p10" value="10"><label for="p10">10</label>
								</span>
								<output for="e_score"><b>0</b>점</output>
							</span>
						</td>
					</tr>
					<tr>
						<td>
							<textarea rows="5" cols="100" name="e_content" style="resize: none; color:black;" placeholder="평가 내용"></textarea>
						</td>
						<td align="center">
	...
	<script>
		...
		var starRating = function(){
		  ...
		  $(document)
		    .on("focusin", ".e_score>.input", function(){
		    $(this).addClass("focus");
		  })
		    .on("focusout", ".e_score>.input", function(){
		    var $this = $(this);
		    setTimeout(function(){
		    ...
		    .on("change", ".e_score :radio", function(){
		    $result.text($(this).next().text());
		  })
		    .on("mouseover", ".e_score label", function(){
		    $result.text($(this).text());
		  })
		    .on("mouseleave", ".e_score>.input", function(){
